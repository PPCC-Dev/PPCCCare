<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Support.Master" CodeBehind="CustomerLogDetails.aspx.vb" Inherits="Support.CustomerLogDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">


     <script type='text/javascript'>
         function openModal(LogId, Cust, Requestor, ReqDate, FormName, DbSite, Problem, Causes, Solutions, ResponseBy, CloseDate, CloseBy, Reply) {
