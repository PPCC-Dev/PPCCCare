...
Imports System.Xml
Public Class CustomerLogDetails
    ...
    Sub Display(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim LogId, Cust, Requestor, ReqDate, FormName, DbSite, Problem, Causes, Solutions, ResponseBy, CloseDate, CloseBy, Reply As String
        ...
        Reply = GetReplyLogNew(txtLogID.Text)
            ...
            If txtLogID.Text <> String.Empty Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If dt.Rows(0).Item("pStat").ToString = "0" Then
                        ...
                        If ddlStat.SelectedItem.Value <> sOldStat Then
                            'Send Mail
    ...
    End Sub
    Sub Ppccinsertreplylog()
        oWS = New ServiceSupport.ServiceSupportSoapClient
        dt = New DataTable
        ds = New DataSet
        Dim Textreply As String = String.Empty

        If ddlStat.SelectedItem.Value <> HiddenStat.Value Then
            Textreply = "Change Status From " & Statusdescription(HiddenStat.Value) & " To " & Statusdescription(ddlStat.SelectedItem.Value) & " And Change Informations"

        End If

        dt = oWS.InsertReplyLog(txtLogID.Text, Textreply, Session("Username").ToString)
        ds.Tables.Add(dt)

    End Sub

    Function Statusdescription(Textreply As String) As String
        ...
        ElseIf Textreply = "I" Then
            Statusdescription = "In-Process"

        ElseIf Textreply = "D" Then
            Statusdescription = "Identify"

        ElseIf Textreply = "F" Then
            Statusdescription = "Awaiting Infor"

        ElseIf Textreply = "M" Then
            Statusdescription = "Monitor"

        ElseIf Textreply = "N" Then
            Statusdescription = "Not Accept"

        ElseIf Textreply = "Q" Then
            Statusdescription = "Internal PPCC QC"

        ElseIf Textreply = "S" Then
            Statusdescription = "Solution Finding"

        ElseIf Textreply = "T" Then
            Statusdescription = "Test on CRP/UAT-QC"

        ElseIf Textreply = "V" Then
            Statusdescription = "Investigate"
    ...
    Function GetReplyLogLast(LogID) As String
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            'For i As Integer = 0 To ds.Tables(0).Rows.Count - 1
            GetReplyLogLast = GetReplyLogLast & "<b><i>" & ds.Tables(0).Rows(0)("username").ToString & "</b> - " & ds.Tables(0).Rows(0)("reply_date").ToString &
                                ": " & "</i>" & vbLf & ds.Tables(0).Rows(0)("reply").ToString & vbLf & vbLf
            'Next
